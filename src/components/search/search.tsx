  ...
  return (
    <>
      <div className="relative basis-8/12 h-full hidden md:flex justify-center items-center">
        <input type="text" 
          className="absolute w-3/4 lg:w-2/3 xl:w-3/5 h-1/2 bg-transparent border-2 border-white rounded-lg outline-none text-center text-white placeholder:text-white/50"
          placeholder="Search movie..."
          onChange={(event) => setSearch(event.target.value)}
        />
        <div className="w-3/4 lg:w-2/3 xl:w-3/5 md:flex justify-end pr-2">
      ...
      <div className="basis-8/12 h-full md:hidden flex justify-end items-center cursor-pointer pr-4">
