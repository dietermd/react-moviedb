...
import { ImagesBaseURL } from "../utils/utils"
  ...
  return (
    <>
      <header className="absolute w-full z-10">
        <nav className="h-[80px] flex items-center px-6">          
          ...
          movies.map((movie, i) =>
            i === 0 ?
              <div key={i} className="relative float-left -mr-[100%] w-full transition-transform duration-[600ms] ease-in-out motion-reduce:transition-none"
                ...
                <img src={ImagesBaseURL + movie.backdrop_path} className="absolute h-[600px] w-full brightness-50" alt="..." />
