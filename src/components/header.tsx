...
export default function Header() {
  ...
  return (
    <div className="relative">
      <img className="absolute h-[600px] w-full object-cover brightness-50" src={ImagesBaseURL + movie.backdrop_path} />
      ...
      <div className="absolute h-[600px] w-full">
        ...
        <div className="h-[400px] w-1/2 flex flex-col gap-8 justify-center items-start px-32">
